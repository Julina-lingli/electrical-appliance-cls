...
class CNN(object):
    ...
    def defineCNN(self):
        ...
        print("1111111111111111111")
        convPool3 = tf.reshape(convPool3, [-1, 80 * 14 * 12])
        # 定义全连接层
        self.out = self.defineFullConnected(convPool3, size=[84, 11])
